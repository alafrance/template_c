...
#    Updated: 2021/03/24 15:57:23 by alafranc         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #

NAME		= libft.a

FILES		= ft_nalloc.c ft_lstnew_prt.c ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
